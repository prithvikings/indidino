...
const Enterprise = () => {
  return (
    <div className="max-w-6xl mx-auto border border-b-0 border-t-0 border-zinc-300 bg-[#FAFAFA] font-sans flex flex-col">
      {/* Top Header Bar */}
      <div className="sticky top-[64px] z-10 bg-[#FAFAFA] flex justify-between items-center px-6 py-4 border-b border-t-0 border-zinc-300 text-xs font-dmmono text-zinc-500 tracking-wider">
        <div>ENTERPRISE</div>
        <div>
      ...
      <div className="text-center px-6 py-28 max-w-3xl mx-auto">
        ...
        <p className="text-md text-zinc-500 leading-relaxed max-w-2xl mx-auto">
          Whether you're a startup, scaling, or a large enterprise,
          Supermemory's engine deploys in any stack and environment.
          State-of-the-art memory, wherever you need it.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 border-t border-zinc-200 bg-[#FAFAFA]">
        ...
        <div className="flex flex-col p-10 py-2 border-b md:border-b-0 md:border-r border-zinc-200">
          ...
          <h3 className="text-md font-space font-semibold text-zinc-900 mb-2">
            Self-host on your premise
          </h3>
          <p className="text-zinc-500 leading-relaxed text-sm">
            Supermemory Enterprise deploys in your VPC, your cloud, your rules.
            Full control.
          </p>
        </div>
