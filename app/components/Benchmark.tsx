...
const Benchmark = () => {
  ...
  const tableData = [
    ...
    {
      feature: "Document Extractors",
      sm: <CheckIcon />,
      mem0: <CrossIcon />,
      zep: <CrossIcon />,
    },
    {
      feature: "Sub-300ms Latency",
      sm: <CheckIcon />,
      mem0: <CrossIcon />,
      zep: <CheckIcon />,
    },
    ...
    {
      feature: "Consumer Plugins",
      sm: <CheckIcon />,
      mem0: <CrossIcon />,
      zep: <CrossIcon />,
    },
    {
      feature: "Open Eval Platform",
      sm: <CheckIcon />,
      mem0: <CrossIcon />,
      zep: <CrossIcon />,
    },
    ...
    <>
      <div className="max-w-6xl mx-auto border border-y-0 bg-neutral-100 border-zinc-300 flex flex-col items-center justify-center p-4 py-6 text-center">
        <p className="text-md font-medium">
          100B+ tokens processed monthly · Every query 300ms
        </p>
      </div>

      {/* Main Section - The sticky header will respect these boundaries */}
      <div className="max-w-6xl mx-auto border-x border-zinc-300 bg-[#FAFAFA] font-sans relative">
        {/* Header Bar - Updated with sticky, top-0, z-50, and background color */}
        <div className="sticky top-[64px] bg-[#FAFAFA] flex justify-between items-center px-6 py-4 border-y border-zinc-300 text-xs font-dmmono text-zinc-500 tracking-wider">
          <div>Benchmark</div>
          <div>
        ...
        <div className="text-center px-6 pt-14 pb-20 max-w-4xl mx-auto flex flex-col items-center gap-2">
          ...
          <p className="text-md text-zinc-500 leading-relaxed max-w-xl mx-auto">
            ...
            LoCoMo, and ConvoMem. We also built{" "}
        ...
        <div className="max-w-4xl mx-auto px-6 mb-24">
          <div className="aspect-video bg-zinc-900 rounded-xl flex flex-col items-center justify-center relative overflow-hidden group cursor-pointer shadow-2xl border border-zinc-800">
            ...
            <svg
              className="w-16 h-16 text-zinc-100 z-20 group-hover:scale-110 transition-transform duration-300"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
        ...
        <div className="px-6 py-8 bg-white flex flex-col items-center">
          <div className="w-full max-w-5xl border border-zinc-200 rounded-xl overflow-hidden font-space">
            ...
            <div className="grid grid-cols-4 bg-white border-b border-zinc-200">
              <div className="p-5 text-sm font-medium text-zinc-600">
                Feature
              </div>
              <div className="p-5 text-sm font-semibold text-zinc-900 text-center bg-zinc-50 border-x border-zinc-200">
                Supermemory
              </div>
              <div className="p-5 text-sm font-medium text-zinc-600 text-center">
                Mem0
              </div>
              <div className="p-5 text-sm font-medium text-zinc-600 text-center">
                Zep
            ...
            {tableData.map((row, index) => (
              ...
              >
                <div className="p-5 py-3.5 text-sm text-zinc-700 font-dmsans">
                  {row.feature}
                </div>
      ...
      <div className="max-w-6xl mx-auto text-center py-6 border border-zinc-300 w-full flex items-center justify-center text-sm text-zinc-500">
        ...
        <span className="ml-2 text-zinc-900 font-medium underline decoration-zinc-300 underline-offset-4">
          here
        </span>
        .
      </div>
