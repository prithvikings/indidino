...
const Hero = () => {
  return (
    <div className="mt-10 border border-b-0 border-zinc-300 max-w-6xl mx-auto bg-zinc-50 pb-16 overflow-hidden max-lg:mx-6 max-md:mx-0 max-md:mt-0 max-md:border-x-0">
      {/* Dashed Section */}
      <div className="w-full border-y border-dashed border-zinc-300 mt-16 px-6 hidden md:flex items-center max-md:mt-8 max-md:justify-center max-md:px-4">
        {/* Announcement Badge */}
      ...
      <div className="flex flex-col gap-16 items-center justify-center mt-24 px-6 max-md:gap-10 max-md:mt-12 max-md:px-4">
        <div className="flex flex-col justify-between items-center gap-7 max-md:gap-5">
          <h1 className="text-5xl text-center font-space font-medium max-w-xl max-md:text-4xl max-sm:text-3xl max-sm:leading-tight">
            Stop forgetting to reply to people
          </h1>
          <p className="text-sm font-dmsans text-zinc-600 font-normal max-w-xl text-center max-sm:px-2">
          ...
          <div className="flex items-center gap-3 max-sm:flex-col max-sm:w-full max-sm:gap-4">
        ...
        {/* YouTube Video Demo */}
        <div className="w-full max-w-4xl h-[500px] bg-zinc-800 rounded-md overflow-hidden shadow-lg border border-zinc-200/50 max-lg:h-[400px] max-md:h-[350px] max-sm:h-[220px]">
          <iframe
            width="100%"
            height="100%"
