...
const About = () => {
  ...
  const zincButtonStyle =
    "bg-zinc-900 text-white px-5 py-2.5 flex items-center gap-2 cursor-pointer hover:bg-zinc-800 transition-colors font-medium rounded-sm shadow-sm";
      ...
      <main className="max-w-6xl mx-auto mt-10 border border-zinc-300 bg-white">
        ...
        <section className="px-6 md:px-12 py-16 border-t border-zinc-200">
          <div className="max-w-3xl">
            <h2 className="text-2xl font-semibold text-zinc-900 font-sans mb-8">
              Mission.
            </h2>
        ...
        <section className="px-6 md:px-12 py-16 border-t border-zinc-200 bg-zinc-50/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {valueCards.map((card) => (
              <div
                key={card.id}
                className="group relative w-full aspect-video rounded-xl overflow-hidden border border-zinc-200 shadow-sm cursor-pointer"
              >
